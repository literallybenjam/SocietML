    ...
    for (i = 0; i < elements.length; i++) {
        ...
        switch (this_element.dataset.societmlType.toLowerCase()) {
            ...
            case "msg":
                ...
                data.container.className = "societml-msg_container";
